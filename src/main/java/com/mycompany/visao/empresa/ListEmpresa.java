 ...
 * @author brian.7908
 */
public class ListEmpresa extends javax.swing.JFrame {

    /**
     * Creates new form ListEmpresa
     */
    public ListEmpresa() {
        initComponents();
    ...
    public void listarTodos(){
        try{ DefaultTableModel dtm = (DefaultTableModel) tableEmpresa.getModel();
            
             tableEmpresa.setModel(dtm);
            ...
            while (resultset.next()){
                ...
                dtm.addRow(new Object[] {id, nome, cnpj});
            }
        } catch (Exception e){
     ...
     public void listarPorId(int pId){
        try{
            DefaultTableModel dtm = (DefaultTableModel) tableEmpresa.getModel ();

            tableEmpresa.setModel(dtm);
            
            DaoEmpresa daoE = new DaoEmpresa();
            
            ResultSet resultset = daoE.listarPorId(pId);
     ...
     public void listarPorNome(String pNome){
                    try{
                        ...
                        ResultSet resultset = daoE.listarPorNome(pNome);
     ...
     public void listarPorCNPJ(String pCNPJ){
                    try{
                        ...
                        ResultSet resultset = daoE.listarPorCNPJ(pCNPJ);
    ...
    private void initComponents() {
        ...
        jcbTipoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "ID", "Empresa", "CNPJ" }));
    ...
    private void tableEmpresaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableEmpresaMouseClicked
        try{
            if (evt.getClickCount() == 2){
                ModEmpresa modE = new ModEmpresa();

                modE.setId(Integer.parseInt(String.valueOf(tableEmpresa.getValueAt(tableEmpresa.getSelectedRow(), 0))));
                modE.setNome(String.valueOf(tableEmpresa.getValueAt(tableEmpresa.getSelectedRow(), 1)));
                modE.setCnpj(String.valueOf(tableEmpresa.getValueAt(tableEmpresa.getSelectedRow(), 2)));

                DadosTemporarios.tempObject = (ModEmpresa) modE;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListEmpresa().setVisible(true);
            }
        });
    }

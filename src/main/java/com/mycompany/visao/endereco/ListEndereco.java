    ...
    public void listarTodos(){
     ...
     public void listarPorRua(String pRua){
                    try{
                        ...
                        ResultSet resultset = daoend.listarPorNomeRua(pRua);
      ...
      public void ListarPorCidade(String nmCid){
                    try{
                        ...
                        ResultSet resultset = daoend.listarPorNomeCid(nmCid);
        ...
        try{
            ...
            ResultSet resultset = daoend.listarPorNumResid(pNum);
    ...
    private void tableEnderecoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableEnderecoMouseClicked
        try{
            if (evt.getClickCount() == 2){
                ...
                modend.setCEP(String.valueOf(tableEndereco.getValueAt(tableEndereco.getSelectedRow(), 3)));
                modend.setNumResid(Integer.parseInt(String.valueOf(tableEndereco.getValueAt(tableEndereco.getSelectedRow(), 4))));

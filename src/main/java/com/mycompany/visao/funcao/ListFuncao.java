 ...
 * @author brian.7908
 */
public class ListFuncao extends javax.swing.JFrame {

    /**
     * Creates new form ListFuncao
     */
    public ListFuncao() {
        initComponents();
     ...
     public void listarTodos(){
        try{ 
            DefaultTableModel dtm = (DefaultTableModel) tableF.getModel();
     ...
     public void listarPorNome(String pNome){
            ...
            tableF.setModel(dtm);
             ...
             ResultSet resultset = daoF.listarPorNome(pNome);
    ...
    private void initComponents() {
        ...
        jcbTipoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "ID", "Função" }));
    ...
    private void tableFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableFMouseClicked
        try{
            if (evt.getClickCount() == 2){
                ModFuncao modF = new ModFuncao();

                modF.setId(Integer.parseInt(String.valueOf(tableF.getValueAt(tableF.getSelectedRow(), 0))));
                modF.setNome(String.valueOf(tableF.getValueAt(tableF.getSelectedRow(), 1)));

                DadosTemporarios.tempObject = (ModFuncao) modF;

                CadFuncao cadF = new CadFuncao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListFuncao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListFuncao().setVisible(true);
            }
        });
    }

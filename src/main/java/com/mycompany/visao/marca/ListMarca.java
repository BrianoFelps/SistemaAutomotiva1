...
public class ListMarca extends javax.swing.JFrame {
    ...
    try{
        DefaultTableModel dtm = (DefaultTableModel) tableMarca.getModel();
            
             tableMarca.setModel(dtm);
     ...
     public void listarPorId(int pId){
        try{
            DefaultTableModel dtm = (DefaultTableModel) tableMarca.getModel();
             ...
             ResultSet resultset = daoM.listarPorId(pId);
     ...
     public void listarPorNome(String pNome){
             ...
             ResultSet resultset = daoM.listarPorNome(pNome);
    ...
    private void tableMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMarcaMouseClicked
        try{
            if (evt.getClickCount() == 2){
                ModMarca modM = new ModMarca();

                modM.setId(Integer.parseInt(String.valueOf(tableMarca.getValueAt(tableMarca.getSelectedRow(), 0))));
                modM.setNome(String.valueOf(tableMarca.getValueAt(tableMarca.getSelectedRow(), 1)));

                DadosTemporarios.tempObject = (ModMarca) modM;

                CadMarca cadM = new CadMarca();
